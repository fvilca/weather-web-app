  ...
  return (
    ...
    >
      ...
      >
        <path
          id="stroke"
          d="M4.5,13.15,17.55,3,30.6,13.15V29.1A2.9,2.9,0,0,1,27.7,32H7.4a2.9,2.9,0,0,1-2.9-2.9Z"
  ...
  return (
    ...
    >
      <g transform="translate(-138 -796)">
        <path
          id="stroke"
          d="M18,9v7.89l5.26,2.63"
          transform="translate(136.5 795.5)"
          fill="none"
          stroke="#939482"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        <g
          ...
          transform="translate(142.547 797.703)"
        >
          <g id="Group_1803" data-name="Group 1803">
            <path
              id="fill"
              d="M80.543,47.185a.922.922,0,0,0-1.254-.359,14.672,14.672,0,0,0-5.161,4.812.922.922,0,0,0,1.546,1.006,12.821,12.821,0,0,1,4.51-4.2A.922.922,0,0,0,80.543,47.185Z"
              transform="translate(-73.979 -46.71)"
              fill="#939482"
            />
          </g>
        </g>
        <g
          id="Group_1806"
          transform="translate(138 796)"
        >
          <g id="Group_1805" data-name="Group 1805">
            <path
              id="fill"
              d="M16.911,19a.922.922,0,0,0,0,1.844A12.725,12.725,0,1,1,4.429,36.017l1.214,1.212a.922.922,0,1,0,1.3-1.305L3.933,32.917a.931.931,0,0,0-.664-.269.921.921,0,0,0-.831.525L.155,36.6A.922.922,0,1,0,1.69,37.624l.906-1.36a15.793,15.793,0,0,0,.411,1.656A14.567,14.567,0,1,0,16.911,19Z"
  ...
  return (
    ...
    >
      <g transform="translate(1 1)">
        <path
          id="stroke"
          d="M28.477,13.488c0,9.324-11.988,17.316-11.988,17.316S4.5,22.812,4.5,13.488a11.988,11.988,0,0,1,23.977,0Z"
        ...
        <path
          id="stroke"
          d="M21.492,14.5a4,4,0,1,1-4-4,4,4,0,0,1,4,4Z"
          transform="translate(-5.508 -2.508)"
          fill="none"
          stroke="#939482"
          strokeLinecap="round"
          strokeLinejoin="round"
